...
postscript("plots/fig6.coor.time.ps",width=7,height=4.1,bg="transparent",colormodel="gray",horizontal = F)
...
#     geom_smooth(method=loess,formula=y~x)+
    ...
    geom_text(data=data.hour.coor[!(data.hour.coor$hour %in% c("01","05","19")),],aes(label=hour),size=1.5,color="#666666")+
