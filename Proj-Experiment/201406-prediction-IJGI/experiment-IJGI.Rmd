...
cate.spl.df = category.by.polygon(checkin.NY, 
                         mapdir="../../global/data/shapefiles", 
                         maplayer="NYC_zipcode")

png("test.png",height=6*ppi, width=8*ppi,res=ppi)
ggplot() +
    geom_polygon(data=cate.spl.df,aes(long,lat,group=group,fill=Category_1),
                     color="grey",alpha=0.9,size=0.3) + 
    coord_map()+
    theme_bw()+
    xlab("")+ylab("")+
